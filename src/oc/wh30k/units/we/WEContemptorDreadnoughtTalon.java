...
public class WEContemptorDreadnoughtTalon extends Eintrag {
	...
	public WEContemptorDreadnoughtTalon() {
		...
		seperator();
		t1 = new RuestkammerStarter(ID, randAbstand, cnt, "WEContemptorKammer", "Contemptor Dreadnought");
		t1.initKammer();
		t1.setAbwaehlbar(false);
		add(t1);

		seperator();
		t2 = new RuestkammerStarter(ID, randAbstand, cnt, "WEContemptorKammer", "Contemptor Dreadnought");
		t2.initKammer();
		add(t2);

		seperator();
		t3 = new RuestkammerStarter(ID, randAbstand, cnt, "WEContemptorKammer", "Contemptor Dreadnought");
		t3.initKammer();
		add(t3);
	...
	public void refreshen() {
            ...
            o1.setAktiv(!o2.isSelected() && BuildaHQ.getCountFromInformationVector("WERoW") == 3);
