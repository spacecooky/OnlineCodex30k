...
public class SHLegionVeteranTacticalSquad extends Eintrag {
	...
	public SHLegionVeteranTacticalSquad() {
		...
		seperator();
		rkBoss = new RuestkammerStarter(ID, randAbstand, cnt, "SHSergeant", "Veteran Sergeant");
