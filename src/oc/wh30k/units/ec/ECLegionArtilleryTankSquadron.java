...
public class ECLegionArtilleryTankSquadron extends Eintrag {
	...
	public ECLegionArtilleryTankSquadron() {
		...
		t1 = new RuestkammerStarter(ID, randAbstand, cnt, "ECArtilleryKammer", "", 1);
		t1.initKammer();
		...
		t2 = new RuestkammerStarter(ID, randAbstand, cnt, "ECArtilleryKammer", "", 1);
		t2.initKammer();
		...
		t3 = new RuestkammerStarter(ID, randAbstand, cnt, "ECArtilleryKammer", "", 1);
		t3.initKammer();
