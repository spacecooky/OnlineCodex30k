...
public class DGContemptorDreadnoughtTalon extends Eintrag {

	RuestkammerStarter t1;
	RuestkammerStarter t2;
	RuestkammerStarter t3;

	public DGContemptorDreadnoughtTalon() {
		...
		t1 = new RuestkammerStarter(ID, randAbstand, cnt, "DGContemptorKammer", "", 1);
		t1.initKammer();
		...
		t2 = new RuestkammerStarter(ID, randAbstand, cnt, "DGContemptorKammer", "", 1);
		t2.initKammer();
		...
		t3 = new RuestkammerStarter(ID, randAbstand, cnt, "DGContemptorKammer", "", 1);
		t3.initKammer();
