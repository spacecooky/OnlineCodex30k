...
public class ECLegionOutriderSquad extends Eintrag {
	...
	public ECLegionOutriderSquad() {
		...
		rkBoss = new RuestkammerStarter(ID, randAbstand, cnt, "ECSergeant", "Outrider Sergeant");
