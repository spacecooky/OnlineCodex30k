...
public class ECTechmarineCovenant extends Eintrag {

	RuestkammerStarter t1;
	RuestkammerStarter t2;
	RuestkammerStarter t3;

	public ECTechmarineCovenant() {
		...
		t1 = new RuestkammerStarter(ID, randAbstand, cnt, "ECTechmarineKammer", "", 1);
		t1.initKammer();
		...
		t2 = new RuestkammerStarter(ID, randAbstand, cnt, "ECTechmarineKammer", "", 1);
		t2.initKammer();
		...
		t3 = new RuestkammerStarter(ID, randAbstand, cnt, "ECTechmarineKammer", "", 1);
		t3.initKammer();
