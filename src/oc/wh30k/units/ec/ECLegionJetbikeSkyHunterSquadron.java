...
public class ECLegionJetbikeSkyHunterSquadron extends Eintrag {
	...
	public ECLegionJetbikeSkyHunterSquadron() {
		...
		rkBoss = new RuestkammerStarter(ID, randAbstand, cnt, "ECSergeant", "Sky Hunter Sergeant");
