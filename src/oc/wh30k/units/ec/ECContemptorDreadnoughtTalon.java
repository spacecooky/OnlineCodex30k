...
public class ECContemptorDreadnoughtTalon extends Eintrag {

	RuestkammerStarter t1;
	RuestkammerStarter t2;
	RuestkammerStarter t3;

	public ECContemptorDreadnoughtTalon() {
		...
		t1 = new RuestkammerStarter(ID, randAbstand, cnt, "ECContemptorKammer", "", 1);
		t1.initKammer();
		...
		t2 = new RuestkammerStarter(ID, randAbstand, cnt, "ECContemptorKammer", "", 1);
		t2.initKammer();
		...
		t3 = new RuestkammerStarter(ID, randAbstand, cnt, "ECContemptorKammer", "", 1);
		t3.initKammer();
