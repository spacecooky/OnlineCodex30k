...
public class SHLegionOutriderSquad extends Eintrag {
	...
	public SHLegionOutriderSquad() {
		...
		rkBoss = new RuestkammerStarter(ID, randAbstand, cnt, "SHSergeant", "Outrider Sergeant");
