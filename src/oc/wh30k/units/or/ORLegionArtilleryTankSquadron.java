...
public class ORLegionArtilleryTankSquadron extends Eintrag {
	...
	public ORLegionArtilleryTankSquadron() {
		...
		t1 = new RuestkammerStarter(ID, randAbstand, cnt, "ORArtilleryKammer", "", 1);
		t1.initKammer();
		...
		t2 = new RuestkammerStarter(ID, randAbstand, cnt, "ORArtilleryKammer", "", 1);
		t2.initKammer();
		...
		t3 = new RuestkammerStarter(ID, randAbstand, cnt, "ORArtilleryKammer", "", 1);
		t3.initKammer();
