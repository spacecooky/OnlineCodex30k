...
public class ORTechmarineKammer  extends RuestkammerVater {

	OptionsUpgradeGruppe o1, o2, o3, o4;
	OptionsZaehlerGruppe o5, o6;
	RuestkammerStarter rkTransport;

	public ORTechmarineKammer () {
            grundkosten = 45;
	}
	...
	public void initButtons(boolean... defaults) {
		...
		rkTransport = new RuestkammerStarter(ID, randAbstand, cnt, "ORTransporterKammer2", "Dedicated transport");
		//Rhino, Pod, Dreadclaw, Phobos, Spartan
		rkTransport.initKammer(true, false, false, false, false);
