...
public class VOLKSonsofHorus extends BuildaVater {
	...
	public VOLKSonsofHorus() {
		...
		String[] LordsofWar = {"", "Horus the Warmaster", "", "Legion Fellblade Super-heavy Tank", "Legion Typhon Heavy Siege Tank", "Legion Thunderhawk Gunship", "Legion Thunderhawk Transporter", "Legion Cerberus Heavy Tank Destroyer", "Legion Malcador Assault Tank"};
