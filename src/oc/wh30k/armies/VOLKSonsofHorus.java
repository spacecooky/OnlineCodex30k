...
public class VOLKSonsofHorus extends BuildaVater {
	...
	public VOLKSonsofHorus() {
		...
		String[] HQeinträge = {"", "Legion Praetor", "Legion Centurion", "  Chaplain", "  Forge lord", "  Legion Champion", "  Librarian", "  Master of signal", "  Moritat", "  Primus medicae", "  Siege breaker", "  Vigilator", "", "Legion Command Squad", "Justaerin Command Squad", "", "Ezekyle Abaddon", "Garviel Loken", "Maloghurst The Twisted", ""};
