...
public class VOLKEmperorsChildren extends BuildaVater {
	...
	public VOLKEmperorsChildren() {
		...
		String[] Eliteeinträge = {"", "Palatin Blade Squad", "Legion Veteran Tactical Squad", "Legion Destroyer Squad", "Legion Terminator Squad", "Techmarine Covenant", "Apothecarion Detachment", "Legion Dreadnought Talon", "Contemptor Dreadnought Talon", "Legion Rapier Weapons Battery"};
		...
		nameDerArtDerArmee = "Emperors Children";
		nameDerArtDerArmeeDekliniert = "Emperors Children";
		textAreaUeberschrift = "Emperors Children";
		/*
