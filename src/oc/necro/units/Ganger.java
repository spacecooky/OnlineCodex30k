...
public class Ganger extends Eintrag {
	...
	public Ganger() {
        ...
        new ProfilPanel(this, 2);

		add(ico = new oc.Picture("oc/images/necro/Ganger.jpg"));
		...
		rkFertigkeiten.initKammer(BuildaHQ.zahlZuBool(2));
