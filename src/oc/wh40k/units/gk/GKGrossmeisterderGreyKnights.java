...
public class GKGrossmeisterderGreyKnights extends Eintrag {

	OptionsUpgradeGruppe o1;
	OptionsUpgradeGruppe o2;

	public GKGrossmeisterderGreyKnights() {
		name = "Großmeister der Grey Knights";
		grundkosten = 175;

		add(ico = new oc.Picture("oc/wh40k/images/GKGrossmeisterderGreyKnights.jpg"));
		
		seperator();

		add(new OptionsEinzelUpgrade(ID, randAbstand, cnt, "", "Meisterschaftsgrad 2", 35));

		seperator();

		ogE.addElement(new OptionsGruppeEintrag("Sturmbolter", 0));
		ogE.addElement(new OptionsGruppeEintrag("Erlöser-Flammenwerfer", 5));
		ogE.addElement(new OptionsGruppeEintrag("Psipulser", 35));
		ogE.addElement(new OptionsGruppeEintrag("Psibolter", 45));
		...
		ogE.addElement(new OptionsGruppeEintrag("Meisterhafter Psipulser", 40));
		ogE.addElement(new OptionsGruppeEintrag("Meisterhafter Psibolter", 50));
