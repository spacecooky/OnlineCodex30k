...
public class GKPurgatortrupp extends Eintrag {
	...
	public GKPurgatortrupp() {
		...
		rkBoss = new RuestkammerStarter(ID, randAbstand, cnt, "GKPurgatorJusticar", "Upgrade zum Justicar");
		rkBoss.initKammer();
