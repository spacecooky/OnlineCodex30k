...
public class BTPredatorAnnihilator extends Eintrag {

	OptionsEinzelUpgrade oe1;

	public BTPredatorAnnihilator() {
		name = "Predator Annihilator";
		grundkosten = 120;

		add(ico = new oc.Picture("oc/wh40k/images/BTPredatorAnnihilator.jpg"));

		add(oe1 = new OptionsEinzelUpgrade(ID, randAbstand, cnt, "", "Sync. Laserkanone", "Synchronisierte Laserkanone", 0));
