...
public class SWHeldderWolfsgarde extends Eintrag {
	...
	public SWHeldderWolfsgarde() {
		name = "Held der Wolfsgarde";
		grundkosten = 70;

		BuildaHQ.addToInformationVector("SWHQ", 1);

		add(ico = new oc.Picture("oc/wh40k/images/SWHeldderWolfsgarde.jpg"));
	...
	public void refreshen() {
		...
		o5.setAktiv("Saga des Jägers", (!o2.isSelected() && !oe2.isSelected()));
