...
public class ABSquadronCommandTank extends Eintrag {
	...
	public ABSquadronCommandTank() {
		name = "Squadron Command Tank";
		grundkosten = 150;

		add(ico = new oc.Picture("oc/wh40k/images/ABSquadronCommandTank.jpg"));
		...
		ogE.addElement(new OptionsGruppeEintrag("Demolisher", "Demolisher cannon", 15));
		ogE.addElement(new OptionsGruppeEintrag("Punisher", "Punisher Gatling gun", 35));
		ogE.addElement(new OptionsGruppeEintrag("Executioner", "Executioner plasma cannon", 40));
