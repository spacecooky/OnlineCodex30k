...
public class RHCompanyCommandSquadKammer extends RuestkammerVater {
	...
	public RHCompanyCommandSquadKammer() {
		grundkosten = 30;
	}
  ...
  @Override
	public void initButtons(boolean... defaults) {
		...
		ogE.addElement(new OptionsGruppeEintrag("Exalted Champion", 15));
		...
		add(chaos = new OptionsEinzelZaehler(0, randAbstand, cnt, "", "Chaos Banner", "Renegade with Chaos Banner", 1, 15));
  ...
  @Override
	public void refreshen() {
		...
		vox.setAktiv(chaos.getAnzahl()+specWeapon.getAnzahl()+weaponTeam.getAnzahl()*2<4);
		chaos.setAktiv(vox.getAnzahl()+specWeapon.getAnzahl()+weaponTeam.getAnzahl()*2<4);
		specWeapon.setAktiv(chaos.getAnzahl()+vox.getAnzahl()+weaponTeam.getAnzahl()*2<4);
		weaponTeam.setAktiv(chaos.getAnzahl()+vox.getAnzahl()+specWeapon.getAnzahl()<3);
