...
public class ORMegaDread extends Eintrag {
	...
	public ORMegaDread() {
		...
		BuildaHQ.getChooserGruppe(5).addSpezialAuswahl("[IA Apocalypse 2nd Ed] Kustom Meka-Dread");
        BuildaHQ.addToInformationVector("ORMega-Dread", 1);
    ...
    public void deleteYourself() {
        BuildaHQ.addToInformationVector("ORMega-Dread", -1);
        if(BuildaHQ.getCountFromInformationVector("ORMega-Dread") <= 0) {
            BuildaHQ.getChooserGruppe(5).removeSpezialAuswahl("[IA Apocalypse 2nd Ed] Kustom Meka-Dread");
        }
