...
public class CMAuserkorene extends Eintrag {
	...
	public void refreshen() {
		...
		o7a.setMaxAnzahl(4-o7c.getAnzahl()-o7b.getAnzahl()-o7d.getAnzahl());
		o7b.setMaxAnzahl(4-o7c.getAnzahl()-o7a.getAnzahl()-o7d.getAnzahl());
		int bolterSubractor=(o8.isSelected()&&count==5?1:0);
		o7d.setMaxAnzahl(4-(bolterSubractor>(o7c.getAnzahl()+o7a.getAnzahl()+o7b.getAnzahl())?bolterSubractor:(o7c.getAnzahl()+o7a.getAnzahl()+o7b.getAnzahl())));
		o7c.setMaxAnzahl(4-(bolterSubractor>(o7d.getAnzahl()+o7a.getAnzahl()+o7b.getAnzahl())?bolterSubractor:(o7d.getAnzahl()+o7a.getAnzahl()+o7b.getAnzahl())));
