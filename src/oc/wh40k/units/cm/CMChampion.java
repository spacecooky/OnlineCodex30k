...
public class CMChampion extends RuestkammerVater {
	...
	public void refreshen() {
		...
		if(isChampion) {
			...
			boolean legal = ((bolter.isSelected()?1:0) + (boltpistole.isSelected()?1:0) + (handwaffe.isSelected()?1:0) + o1.getAnzahl() + o2.getAnzahl())==3;
		...
		if(isKhorne) {
			...
			boolean legal = ((boltpistole.isSelected()?1:0) + (handwaffe.isSelected()?1:0) + o1.getAnzahl() + o2.getAnzahl())==2;
			boltpistole.setLegal(legal);
			handwaffe.setLegal(legal);
			o1.setLegal(legal);
			o2.setLegal(legal);
		...
		if(isSlaanesh){
			...
			boolean legal = ((bolter.isSelected()?1:0) + (boltpistole.isSelected()?1:0) + o1.getAnzahl() + o2.getAnzahl())==2;
			bolter.setLegal(legal);
			boltpistole.setLegal(legal);
			o1.setLegal(legal);
			o2.setLegal(legal);
