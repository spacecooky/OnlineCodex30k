...
public class EDDropSentinelSquadron extends Eintrag {
	...
	public EDDropSentinelSquadron() {
		...
		squad = new AnzahlPanel(ID, randAbstand, cnt, "Drop Sentinel", "Drop Sentinels", 1, 3, 35);
		...
		rkTransport = new RuestkammerStarter(ID, randAbstand, cnt, "EDValkyrieSkyTalonTransportKammer", "Valkyrie Sky Talon Transport");
