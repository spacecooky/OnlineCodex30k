...
public class EDPlatoonCommandSquad extends RuestkammerVater {
  ...
  @Override
	public void initButtons(boolean... defaults) {
		...
		add(new OptionsEinzelUpgrade(ID, randAbstand, cnt, "", "Homing beacon", 10));
		...
		add(oe4 = new OptionsEinzelZaehler(0, randAbstand + 280, cnt, "", "Lascutter", "Guardsman with Lascutter", 1, 10));
		...
		rkTransport = new RuestkammerStarter(ID, randAbstand + 280, cnt, "EDValkyrie", "Valkyrie Airborne Assault Carrier");
