...
public class EMTehenhauin extends Eintrag {
	...
	public EMTehenhauin() {
		name = BuildaHQ.translate("Tehenhauin");
		grundkosten = 250;

		add(ico = new oc.Picture("oc/whfb/images/EMTehenhauin.jpg"));
		...
		add(new OptionsEinzelUpgrade(ID, randAbstand, cnt, "", BuildaHQ.translate("Maschine der Götter"), 290));
