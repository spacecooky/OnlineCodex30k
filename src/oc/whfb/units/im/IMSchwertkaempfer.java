...
public class IMSchwertkaempfer extends Eintrag {
	...
	public IMSchwertkaempfer() {
		name = BuildaHQ.translate("Schwertkämpfer");
		grundkosten = 0;

		squad = new AnzahlPanel(ID, randAbstand, cnt, BuildaHQ.translate("Schwertkämpfer"), 10, 100, 6);
