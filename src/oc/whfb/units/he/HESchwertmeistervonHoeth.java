...
public class HESchwertmeistervonHoeth extends Eintrag {
	...
	public HESchwertmeistervonHoeth() {
		name = BuildaHQ.translate("Schwertmeister von Hoeth");
		grundkosten = 0;

		squad = new AnzahlPanel(ID, randAbstand, cnt, BuildaHQ.translate("Schwertmeister von Hoeth"), 5, 100, 15);
		squad.setGrundkosten(0);
		add(squad);

		add(ico = new oc.Picture("oc/images/HESchwertmeistervonHoeth.jpg"));
