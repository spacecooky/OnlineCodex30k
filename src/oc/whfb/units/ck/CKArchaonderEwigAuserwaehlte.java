...
public class CKArchaonderEwigAuserwaehlte extends Eintrag {
	
	RuestkammerStarter rkLore;
	boolean genSelected = false;
	OptionsEinzelUpgrade oGen;

	public CKArchaonderEwigAuserwaehlte() {
		name = BuildaHQ.translate("Archaon der Ewig Auserwählte");
		grundkosten = 685;

		add(ico = new oc.Picture("oc/whfb/images/CKArchaonderEwigAuserwaehlte.jpg"));
