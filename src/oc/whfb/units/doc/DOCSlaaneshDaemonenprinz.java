...
public class DOCSlaaneshDaemonenprinz extends Eintrag {
	...
	public DOCSlaaneshDaemonenprinz() {
		name = BuildaHQ.translate("Slaanesh Dämonenprinz");
		grundkosten = 335;
		...
		rkMagic.initKammer(false, false, false, true, true, false, false, false, false);
