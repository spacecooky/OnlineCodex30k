...
public class VOLKvanSaar extends BuildaVater {
	...
	public VOLKvanSaar() {
		...
		nameDerArtDerArmee = "Haus van Saar";
		nameDerArtDerArmeeDekliniert = "van Saar-Gang";
		textAreaUeberschrift = "Meine van Saar-Gang";
