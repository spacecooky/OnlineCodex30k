...
public class VOLKWorldEaters extends BuildaVater {
	...
	public VOLKWorldEaters() {
		...
		String[] Eliteeinträge = {"", "Legion Mortis Dreadnought", "Contemptor-Mortis Dreadnought", "Legion Destroyer Squad", "Techmarine Covenant", "Apothecarion Detachment", "Legion Dreadnought Talon", "Contemptor Dreadnought Talon", "Legion Rapier Weapons Battery", "", "Rampager Squad"};
