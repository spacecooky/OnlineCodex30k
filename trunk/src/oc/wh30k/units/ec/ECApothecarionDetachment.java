...
public class ECApothecarionDetachment extends Eintrag {

	RuestkammerStarter t1;
	RuestkammerStarter t2;
	RuestkammerStarter t3;

	public ECApothecarionDetachment() {
		...
		t1 = new RuestkammerStarter(ID, randAbstand, cnt, "ECApothecaryKammer", "", 1);
		t1.initKammer();
		...
		t2 = new RuestkammerStarter(ID, randAbstand, cnt, "ECApothecaryKammer", "", 1);
		t2.initKammer();
		...
		t3 = new RuestkammerStarter(ID, randAbstand, cnt, "ECApothecaryKammer", "", 1);
		t3.initKammer();
