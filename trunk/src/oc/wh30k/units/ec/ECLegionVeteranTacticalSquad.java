...
public class ECLegionVeteranTacticalSquad extends Eintrag {
	...
	public ECLegionVeteranTacticalSquad() {
		...
		rkBoss = new RuestkammerStarter(ID, randAbstand, cnt, "ECSergeant", "Veteran Sergeant");
