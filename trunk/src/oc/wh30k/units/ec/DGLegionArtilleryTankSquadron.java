...
public class DGLegionArtilleryTankSquadron extends Eintrag {
	...
	public DGLegionArtilleryTankSquadron() {
		...
		t1 = new RuestkammerStarter(ID, randAbstand, cnt, "DGArtilleryKammer", "", 1);
		t1.initKammer();
		...
		t2 = new RuestkammerStarter(ID, randAbstand, cnt, "DGArtilleryKammer", "", 1);
		t2.initKammer();
		...
		t3 = new RuestkammerStarter(ID, randAbstand, cnt, "DGArtilleryKammer", "", 1);
		t3.initKammer();
