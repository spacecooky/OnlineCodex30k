...
public class WEApothecarionDetachment extends Eintrag {
	...
	public WEApothecarionDetachment() {
		...
		t1 = new RuestkammerStarter(ID, randAbstand, cnt, "WEApothecaryKammer", "", 1);
		t1.initKammer();
		...
		t2 = new RuestkammerStarter(ID, randAbstand, cnt, "WEApothecaryKammer", "", 1);
		t2.initKammer();
		...
		t3 = new RuestkammerStarter(ID, randAbstand, cnt, "WEApothecaryKammer", "", 1);
		t3.initKammer();
