...
public class DGConsulServoKammer extends RuestkammerVater {
	...
	public void refreshen() {
		if (isCenturion || isChampion || isChaplain || isPrimus || isSiege) {
			...
			o1d.setAktiv(2, o1a.isSelected(1) && !o1c.isSelected());
			}	
		
		else if (isForge) {
			o2a.setAktiv(!o2c.isSelected());
			o2b.setAktiv(!o2c.isSelected());
			o2d.setAktiv(1, o2a.isSelected(1) && !o2c.isSelected());
			}
		
		else if (isLibrarian) {
			o3c.setAktiv(2, o3a.isSelected(1));
			}
