...
public class DOCGrosserVerpester extends Eintrag {
	...
	public DOCGrosserVerpester() {
		name = BuildaHQ.translate("Großer Verpester");
		grundkosten = 450;
		...
		rkMagic.initKammer(false, false, true, false, false, false, false, false, false);
