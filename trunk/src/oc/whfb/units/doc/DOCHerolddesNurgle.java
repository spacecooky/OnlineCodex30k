...
public class DOCHerolddesNurgle extends Eintrag {
	...
	public DOCHerolddesNurgle() {
		name = BuildaHQ.translate("Herold des Nurgle");
		grundkosten = 115;
		...
		rkMagic.initKammer(false, false, false, false, false, false, false, true, false);
