...
public class DOCNurgleDaemonenprinz extends Eintrag {
	...
	public DOCNurgleDaemonenprinz() {
		name = BuildaHQ.translate("Nurgle Dämonenprinz");
		grundkosten = 335;
		...
		rkMagic.initKammer(false, false, true, false, true, false, false, false, false);
