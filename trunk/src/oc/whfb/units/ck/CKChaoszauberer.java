...
public class CKChaoszauberer extends Eintrag {
	...
	public CKChaoszauberer() {
		name = BuildaHQ.translate("Chaoszauberer");
		grundkosten = 85;

		add(ico = new oc.Picture("oc/whfb/images/CKChaoszauberer.jpg"));
		...
		rkGifts.initKammer(true, false, false, true);
		...
		rkMagic.initKammer(true, false, true, false);
