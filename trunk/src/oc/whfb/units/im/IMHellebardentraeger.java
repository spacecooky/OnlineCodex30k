...
public class IMHellebardentraeger extends Eintrag {
	...
	public IMHellebardentraeger() {
		name = BuildaHQ.translate("Hellebardenträger");
		grundkosten = 0;
	
		squad = new AnzahlPanel(ID, randAbstand, cnt, BuildaHQ.translate("Hellebardenträger"), 10, 100, 5);
		squad.setGrundkosten(0);
		add(squad);

		seperator();
		
		add(oe8 = new OptionsEinzelUpgrade(ID, randAbstand, cnt, "", BuildaHQ.translate("Schilde"), 1));
	...
	public void refreshen() {
		...
		oe8.setPreis(squad.getModelle() * 1);
