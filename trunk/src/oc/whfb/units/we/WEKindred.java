...
public class WEKindred extends RuestkammerVater {
	...
	public void initButtons(boolean... defaults) {
		...
		ogE.addElement(new OptionsGruppeEintrag(BuildaHQ.translate("Kampftänzer-Sippe"), 50));
		ogE.addElement(new OptionsGruppeEintrag(BuildaHQ.translate("Wilde Jäger-Sippe"), 50));
		ogE.addElement(new OptionsGruppeEintrag(BuildaHQ.translate("Waldläufer-Sippe"), 45));
