...
public class EMLordMazdamundi extends Eintrag {
	
	RuestkammerStarter rkLore;
	boolean genSelected = false;
	OptionsEinzelUpgrade oGen;

	public EMLordMazdamundi() {
		name = BuildaHQ.translate("Lord Mazdamundi");
		grundkosten = 620;

		add(ico = new oc.Picture("oc/whfb/images/EMLordMazdamundi.jpg"));
