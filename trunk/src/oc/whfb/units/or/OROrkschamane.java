...
public class OROrkschamane extends Eintrag {
	...
	public OROrkschamane() {
		name = BuildaHQ.translate("Orkschamane");
		grundkosten = 65;
		...
		rkMount.initKammer(false, true, true, false, false);
		...
		rkMagic.initKammer(true, false, true, true, false, false);
