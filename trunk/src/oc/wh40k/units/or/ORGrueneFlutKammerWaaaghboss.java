...
public class ORGrueneFlutKammerWaaaghboss extends RuestkammerVater {

	OptionsEinzelUpgrade waaaghboss;
	OptionsUpgradeGruppe bossCC;
    OptionsUpgradeGruppe bossFK;
    OptionsEinzelUpgrade megarüstung;
	...
	public ORGrueneFlutKammerWaaaghboss() {
		grundkosten = 0;
	}
	...
	public void initButtons(boolean... defaults) {
        ...
        add(megarüstung = new OptionsEinzelUpgrade(ID, randAbstand, cnt, "", "Megarüstung", 40));
    ...
    public void refreshen() {
        ...
        panzarüstung.setAktiv(!megarüstung.isSelected());
