...
public class CM2007ChaosDecimatorDaemonEngine extends Eintrag {
	...
	public CM2007ChaosDecimatorDaemonEngine() {
		...
		ogE.addElement(new OptionsGruppeEintrag("Soul Burner Petard", 10));
