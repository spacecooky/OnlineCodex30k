...
public class CM2007DreadclawKammer extends RuestkammerVater {
	...
	public void initButtons(boolean... defaults) {
                ...
                auserkorene = new RuestkammerStarter(ID, randAbstand, cnt, "CMAuserkoreneChaosSpaceMarinesKammer", "Auserkorene",1);
                auserkorene.initKammer();
        		add(auserkorene);
        		auserkorene.setButtonText("Auserkorene");
        		
        		besessene = new RuestkammerStarter(ID, randAbstand, cnt, "CMBesesseneChaosSpaceMarinesKammer", "Besessene",1);
        		...
        		cybot.initKammer();
        		add(cybot);
        		cybot.setButtonText("Chaos Cybot");
