...
public class SMContemptorDreadnought extends Eintrag {
	...
	public SMContemptorDreadnought() {
		...
		ogE.addElement(new OptionsGruppeEintrag("Cybot-NKW + Graviton Bl", "Cybot-Nahkampfwaffe + Graviton Blaster", 20));
...
//		ogE.addElement(new OptionsGruppeEintrag("Sturmkanone", 10));
		...
		ogE.addElement(new OptionsGruppeEintrag("Kettenfaust + Graviton Bl", "Kettenfaust + Graviton Blaster", 35));
		...
		add(new OptionsEinzelUpgrade(ID, randAbstand, cnt, "", "Targeting Augury", 15));
