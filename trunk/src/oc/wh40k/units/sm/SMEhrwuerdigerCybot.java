...
public class SMEhrwuerdigerCybot extends Eintrag {
	...
	RuestkammerStarter rkPod;
        ...
        boolean siegeForce = OnlineCodex.getInstance().isCurrentArmy(oc.wh40k.armies.VOLKSiegeVanguardIA10.class);
        
	public SMEhrwuerdigerCybot() {
