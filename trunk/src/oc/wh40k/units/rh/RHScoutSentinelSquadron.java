...
public class RHScoutSentinelSquadron extends Eintrag {
	...
	public RHScoutSentinelSquadron() {
		name = "Scout Sentinel Squadron";
		grundkosten = 0;

		squad = new AnzahlPanel(ID, randAbstand, cnt, "Scout Sentinel", "Scout Sentinels", 1, 3, 35);
