...
public class RHRenegadeArmouredFistSquad extends Eintrag {
	...
	public RHRenegadeArmouredFistSquad() {
		name = "Renegade Armoured Fist Squad";
		grundkosten = 50;
		überschriftSetzen=true;

		add(ico = new oc.Picture("oc/wh40k/images/RHRenegadeArmouredFistSquad.jpg"));
